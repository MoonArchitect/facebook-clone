...
const HappyIcon = <img src="https://static.xx.fbcdn.net/rsrc.php/v3/y7/r/_RWOIsUgWGL.png?_nc_eui2=AeHmi-iv8VZdJfcOM62FJDJopRYQ3zWJHxilFhDfNYkfGEnjqhDZHzk2okn4tVs7Grha0kA7UXm2IPfHq24AIBoW" className={styles.iconImage} alt="" />  // eslint-disable-line
      ...
      <div className={styles.container}>
        <div className={styles.firstRow}>
          <div className={styles.thumbnailContainer}>
            <ProfilePreview thumbnailID={data?.thumbnailID} link="/profile" />
          </div>
